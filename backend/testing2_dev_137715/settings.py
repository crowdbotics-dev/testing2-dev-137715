"""
Django settings for testing2_dev_137715 project.
...
ROOT_URLCONF = 'testing2_dev_137715.urls'
...
WSGI_APPLICATION = 'testing2_dev_137715.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Testing2 Support <support@testing2-dev-137715.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing2_dev_137715 API",
    "DESCRIPTION": "API documentation for testing2_dev_137715 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "testing2_dev_137715.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "testing2_dev_137715.storage_backends.AzureStaticStorage"
